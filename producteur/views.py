...
def fiche_producteur(request,id):
    ...
    identifie=False
    readOnlyField=True
    print(producteur.connexions_id)
    #print(request.session['id'])
    if 'id' in request.session and producteur.connexions_id==request.session['id']:
        readOnlyField=False
        identifie=True
        context['formProducteur']=ProducteurForm(readOnlyField=readOnlyField,idProducteur=producteur.id)
    ...
    if request.method == 'POST':
        ...
        formProducteur = ProducteurForm(readOnlyField=readOnlyField,idProducteur=producteur.id, data=request.POST or request.FILES, error_class=ParagraphErrorList)
